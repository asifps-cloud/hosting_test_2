  ...
  stages {
    stage('Checkout') {
      steps {
        ...
        //git branch: 'main', url: 'https://github.com/asifps-cloud/hosting_test_2'
      }
    }
    ...
    stage('Build and Push Docker Image') {
      environment {
        DOCKER_IMAGE = "asifpsdocker/static-website-2:${BUILD_NUMBER}"
        ...
        steps {
            withCredentials([string(credentialsId: 'github', variable: 'GITHUB_TOKEN')]) {
                sh '''
                    ...
                    sed -i "s|image: .*|image: asifpsdocker/static-website-2:${BUILD_NUMBER}|g" k8s/deployment.yml
